...
public class SQLite extends Database {
    String dbname;
    public SQLite(DNDClothesAPI instance){
        super(instance);
        dbname = plugin.getConfig().getString("plugins/ClothAPI/clothapi.db", "player_clothes"); // Set the table name here e.g player_kills
    }
    ...
    public String SQLiteCreateTokensTable = "CREATE TABLE IF NOT EXISTS table_name (" + // make sure to put your table name in here too.
            ...
            "`basebody` varchar(32) NOT NULL," +
            "`clothes` varchar(32) NOT NULL," +
